...
//CUDA-12 port: __shfl_down was removed; use the _sync variant with a full mask.
//REQUIREMENT: every warp of the calling block must be full (blockDim.x % 32 == 0),
//otherwise the shuffle reads undefined lanes. CG kernels are launched with 96
//threads (updateXWithCGKernel2) to satisfy this.
